...
This example will serve an HTTP response of "Hello OpenShift!".
    ...
    $ oc new-project 02-springboot-openshift-project --description='This is an example project to demonstrate OpenShift v3 - Springboot' --display-name='02 Spring Boot'
    $ oc create -f springboot-pod.json
